...
Object.assign(en, {
  ...
  "恢复基础配置，绑定 OAuth 并一键修复后打开实例": "Reset baseline, sync, bind OAuth, run Repair All, then open the instance",
...
Object.assign(ru, {
  ...
  "恢复基础配置，绑定 OAuth 并一键修复后打开实例": "Сбросить настройки, синхронизировать, привязать OAuth, исправить всё и открыть экземпляр",
...
Object.assign(simplifiedToTraditional, {
  ...
  "恢复基础配置，绑定 OAuth 并一键修复后打开实例": "還原基礎設定，綁定 OAuth 並一鍵修復後開啟執行個體",
