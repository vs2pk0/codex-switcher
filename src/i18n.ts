...
Object.assign(en, {
  ...
  "恢复基础配置，同步后自动打开实例": "Reset baseline, sync, then open the instance",
...
Object.assign(ru, {
  ...
  "恢复基础配置，同步后自动打开实例": "Сбросить настройки, синхронизировать и открыть экземпляр",
...
Object.assign(simplifiedToTraditional, {
  ...
  "恢复基础配置，同步后自动打开实例": "還原基礎設定，同步後自動開啟執行個體",
