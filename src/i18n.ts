...
Object.assign(en, {
  ...
  "客户端内置基线": "Bundled Client Baseline",
  "服务状态": "Service Status",
  "已停止": "Stopped",
  ...
  "内置版本始终保留，可随时安全回退。": "The bundled version is always retained for safe rollback.",
  ...
  "回退内置版本": "Roll Back to Bundled Version",
...
Object.assign(ru, {
  ...
  "客户端内置基线": "Встроенная базовая версия",
  "服务状态": "Статус сервиса",
  "已停止": "Остановлен",
  ...
  "内置版本始终保留，可随时安全回退。": "Встроенная версия всегда сохраняется для безопасного отката.",
  ...
  "回退内置版本": "Вернуться к встроенной версии",
